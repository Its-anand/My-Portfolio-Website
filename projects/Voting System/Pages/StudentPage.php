        ...
        if($result)
        {
            ...
            if(mysqli_num_rows($result)>0)
            {
                ...
                <tr>
                    ...
                    <th>
                        <form action='../Database/Voting_page.php' method='POST'>
                            <input type="hidden" name="partyName" value='<?php echo $res['party_name']?>'>
                            <input type='submit' class='votingButton' name='VoteSubmit' value='Vote'>
                        </form>
                    </th>
                </tr>
                <?php
