...
?>
   ...
   <nav id="nav" class="tab">
      <ul>
         <li class="old_notices"><a href="./index.php">All Notices</a></li>
...
?>
   ...
   <nav id="comment_system" class="tab ">
      <ul style="justify-content: unset;">
         <h3><?php echo $commentNo ?> Comments</h3>
...
if(isset($_SESSION['StudentLoginId']) && $_SESSION['StudentLoginId']==true)
{
  ...
  <input type='hidden' name='notice_id' value='$notice_id'>
         ...
         <button type='submit' name='like_submit' class='navigation_panel_button_css'>
            <img title='$likeNo Like' class='button_style' src='./index_files/image/like.jpg' width='50px' alt=''>
         </button>
         </form> ";
         }
         else if(isset($_SESSION['AdminLoginId']) && $_SESSION['AdminLoginId']==true)
...
{
  echo"
  <img title='$commentNo Comment' class='button_style comment_btn' src='./index_files/image/comment.jpg' alt=''>
  ";
}
else if(isset($_SESSION['AdminLoginId']) && $_SESSION['AdminLoginId']==true)
{
